...
require('lazy').setup {
  ...
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      -- Useful status updates for LSP. Is very nice, but unfortunately REALLY slow
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'rust', 'python', 'bash', 'r', 'dockerfile' },
  ...
  -- There are different scopes, and by defualt the global scope is enabled.
  {
    ...
    keys = {
      ...
      { '<leader>8', '<cmd>Grapple select index=8<cr>', desc = 'Select eigth tag' },
